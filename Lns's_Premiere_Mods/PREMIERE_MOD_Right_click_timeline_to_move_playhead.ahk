...
timeline1 = 0x434343 ;timeline color inside the in/out points ON a targeted track
timeline2 = 0x191919 ;timeline color of the separating LINES between targeted AND non targeted tracks inside the in/out points
timeline3 = 0x1D1D1D ;the timeline color inside in/out points on a NON targeted track
timeline4 = 0x222222 ;the color of the bare timeline NOT inside the in out points
timeline5 = 0xFFFFFF ;the color of a SELECTED blank space on the timeline, NOT in the in/out points
timeline6 = 0xFFFFFF ;the color of a SELECTED blank space on the timeline, IN the in/out points, on a TARGETED track
timeline7 = 0xFFFFFF ;the color of a SELECTED blank space on the timeline, IN the in/out points, on an UNTARGETED track
...
if (colorr = timeline5 || colorr = timeline6 || colorr = timeline7) ;these are the timeline colors of a selected clip or blank space, in or outside of in/out points.
	send ^+a ;in Premiere 13.0, ESCAPE will now deselect clips on the timeline, in addition to its other uses. i think it is good ot use here, now. But you can swap this out with CTRL SHIFT D if you like.
